...
whiptail --title "Conversor de Unidades - CATEC" --msgbox "Sejam bem-vindo." --fb 10 80
...
while [ "$repetir" = "Sim" ]; do
    mostrar_menu
    read -p "Por favor digite um número: " x

    case "$x" in
        1)
            read -p "Digite um valor em m²: " n1
            awk -v n1="$n1" 'BEGIN {
                a = n1
                b = n1 * 100
                c = n1 * 10000
                ...
                print "------------------------------"
                printf "%g township |%g milha quadrada |%g homestead |%g acre |%g rood |%g rod quadrado |%g perch |%g yd² |%g ft² |%g in² |%g th² |\n", j, k, l, m, n, o, p, q, r, s, t
                ...
                print "-------------ROMA-------------"
                print "------------------------------"
                printf "%g saltus |%g centurium |%g geredium |%g uger |%g akt quadrado |%g klima |%g akt quadrado pequeno |%g decimpeda quadrada |%g ped quadrado comum |%g ped quadrado legal |\n", bn, bo, bp, bq, br, bs, bt, bu, bv, bw

                print "------------------------------"
                print "--------FRANCÊS ANTIGO--------"
                print "------------------------------"
                printf "%g arpent |%g perche |%g toise quadrada |%g pied |%g pouce |\n", bx, by, bz, ca, cb
                ...
                print "-----------------------------"
                printf "%g braça quadrada |%g vara quadrada |%g palmo quadrado |%g polegada quadrada |\n", co, cp, cq, cr

                print "-----------------------------"
                print "--------RÚSSIA ANTIGA--------"
                print "-----------------------------"
                printf "%g desyatina país |%g desyatina fazendeiros |%g verst quadrado |%g arshin quadrado |%g pé quadrado |\n", cs, ct, cu, cv, cw

                print "------------------------------"
                print "---------AINDA EM USO---------"
                print "------------------------------"
                printf "%g dulum (дулум) da Bósnia, Herzegovina e Sérvia |%g dynym ou dylym da Albânia |%g donum do Chipre |%g skales (σκάλες) do Chipre |%g stremma grega |%g stremma turca da Grécia |%g dunam do Iraque |%g dunam (dönüm, دونم) da Turquia, Síria, Israel, Palestina, Jordânia, Líbano |%g dunam (dönüm, دونم) antigo (anterior a 1928) da Turquia, Síria, Israel, Palestina, Jordânia, Líbano |%g feddan (فدّان) do Egito, Sudão, Síria, Omã |%g kirat (قيراط) do Egito |%g manzana da Argentina |%g manzana da Belize |%g manzana da Costa Rica |%g manzana da Guatemala |%g manzana da Honduras |%g manzana da Nicarágua |%g cuadra da Argentina |%g cuadra do Chile |%g cuadra do Equador |%g cuadra do Paraguai |%g cuadra do Peru |%g cuadra do Uruguai |%g vara quadrada do Panamá e da Colômbia |%g vara quadrada do Chile, Costa Rica, República Dominicana, Equador, El Salvador, Guatemala, Honduras, México, Nicarágua, Peru, São Tomé e Príncipe, Venezuela |%g vara quadrada de Cuba |%g vara quadrada da Argentina, Paraguai, Uruguai |%g vara quadrada do Brasil |\n", cx, cy, cz, da, db, dc, dd, de, df, dg, dh, di, dj, dk, dl, dm, dn, do1, dp, dq, dr, ds, dt, du, dv, dw, dx, dy

                print "-----------------------------"
                print "-------BITOLA DOS FIOS-------"
                print "-----------------------------"
                printf "%g polegada circular |%g kcmil, MCM |%g cmil |\n", dz, ea, eb
            ...
            ;;
        2)
            read -p "Digite um valor em l: " n1
            awk -v n1="$n1" 'BEGIN {
                a = n1 / 100
                b = n1 / 10
                c = n1
                ...
                print "---------EUA LÍQUIDOS---------"
                print "------------------------------"
                printf "%g acre-pé |%g barril (petróleo) |%g gal |%g qt |%g pt |%g gill |%g fl oz |%g fl dr |%g min |\n", m, n, o, p, q, r, s, t, u
                ...
                print "---------APOTHECARIES---------"
                print "------------------------------"
                printf "%g pt |%g copo de vidro |%g xícara de café da manhã |%g xícara de chá |%g taça de vinho |%g ƒ℥ |%g colher de sopa |%g colher de sobremesa |%g ƒʒ |%g colher de chá |%g minim |\n", ab, ac, ad, ae, af, ag, ah, ai, aj, ak, al
                ...
                print "---------EUA|CERVEJA---------"
                print "-----------------------------"
                printf "%g Barril de cerveja norte-americano |%g Meio-barril de cerveja norte-americano |%g Barrilete de cerveja norte-americano (típico) |%g Quarto de barril de cerveja norte-americano |\n", bx, by, bz, ca

                print "-----------------------------"
                print "--------EUA~CULINÁRIA--------"
                print "-----------------------------"
                printf "%g xícara |%g colher de sopa |%g colher de chá |\n", cb, cc, cd

                print "-----------------------------"
                print "-----AUSTRÁLIA~CULINÁRIA-----"
                print "-----------------------------"
                printf "%g colher de sopa |%g colher de sobremesa |%g colher de chá |\n", ce, cf, cg
                ...
                print "----------ASTRONOMIA----------"
                print "------------------------------"
                printf "%g pc³ |%g ano-luz cúbico |%g minuto-luz cúbico |%g segundo-luz cúbico |\n", cl, cm, cn, co

                print "-----------------------------"
                print "------------NAVAL------------"
                print "-----------------------------"
                printf "%g arqueação |%g tonelada de registro |%g Sistema de Medição Universal do Canal do Panamá |\n", cp, cq, cr

                print "-----------------------------"
                print "-----------MADEIRA-----------"
                print "-----------------------------"
                printf "%g milhão de board-feet (mmfbm, mmbdft, mmbf) |%g corda |%g mil board-feet (mfbm, mbdft, mbf) |%g HT |%g tonelada cúbica de madeira |%g estere |%g hoppus pé, hoppus ft³ (h ft) |%g board-foot (fbmm, bdft, bf) |\n", cs, ct, cu, cv, cw, cx, cy, cz
            ...
            ;;
        3)
            read -p "Digite um valor em km: " n1
            awk -v n1="$n1" 'BEGIN {
                a = n1
                b = n1 * 10
                c = n1 * 100
                ...
                print "-------MEDIDAS MÉTRICAS-------"
                print "------------------------------"
                printf "%g km |%g hm |%g dam |%g m |%g dm |%g cm |%g mm |%g mícron |%g nm |%g Å|\n", a, b, c, d, e, f, g, h, i, j

                print "------------------------------"
                print "-------EUA E INGLATERRA-------"
                print "------------------------------"
                printf "%g légua |%g mi |%g land |%g furlong |%g bolt |%g chain |%g pole |%g rd |%g perch |%g yd |%g ft |%g palmo |%g hand |%g in |%g linha |%g mil |%g micropolegada |\n", k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa

                print "------------------------------"
                print "----------INGLATERRA----------"
                print "------------------------------"
                printf "%g légua |%g mi |%g land |%g skein |%g bolt |%g shackle |%g furlong |%g corrente |%g rope |%g pole |%g goad |%g ell |%g yd |%g ritmo |%g côvado |%g ft |%g palmo |%g nail |%g shaftment |%g hd |%g plm |%g in |%g finger |%g digitus |%g grãos de cevada |%g sementes de papoula |%g linha |%g botão |%g calibre |%g thou |%g mil |\n", ab, ac, ad, ae, af, ag, ah, ai, aj, ak, al, au, av, aw, ax, ay, az, ba, bb, bc, bd, be, bf, bg, bh, bi, bj, bk, bl, bm, bn

                print "-----------------------------"
                print "-----AGRIMENSURA DOS EUA-----"
                print "-----------------------------"
                printf "%g furlong |%g corrente de ramsden - engenharia |%g corrente de gunter - agrimensor |%g corrente de gurley |%g pole de gunter |%g yard de gunter |%g link de ramsden |%g link de gunter |%g link de gurley |%g pé de gunter |\n", bo, bp, bq, br, bs, bt, bu, bv, bw, bx
                ...
                print "---------NÁUTICA EUA---------"
                print "-----------------------------"
                printf "%g milha marítima norte-americana |%g cabo norte-americano |%g fath |\n", cc, cd, ce

                print "------------------------------"
                print "------NÁUTICA INGLATERRA------"
                print "------------------------------"
                printf "%g mira do almirantado |%g cabo do almirantado |\n", cf, cg

                print "-----------------------------"
                print "-----------ESPANHA-----------"
                print "-----------------------------"
                printf "%g cuadra da Argentina |%g cuadra da Bolívia |%g cuadra do Chile |%g cuadra da Colômbia |%g cuadra do Equador |%g cuadra da Nicarágua |%g cuadra do Paraguai |%g cuadra do Uruguai |%g vara da Argentina |%g vara do Brasil |%g vara do Chile |%g vara da Colômbia |%g vara da Costa Rica |%g vara de Cuba |%g vara da República Dominicana |%g vara do Equador |%g vara de El Salvador |%g vara da Guatemala |%g vara de Honduras |%g vara do México |%g vara da Nicarágua |%g vara do Panamá |%g vara do Paraguai |%g vara do Peru - peruano |%g vara do Peru - espanhol |%g vara do Uruguai |%g vara de São Tomé e Príncipe |%g vara da Venezuela |\n", ch, ci, cj, ck, cl, cm, cn, co, cp, cq, cr, cs, ct, cu, cv, cw, cx, cy, cz, da, db, dc, dd, de, df, dg, dh, di
                ...
                print "-------------ATA-------------"
                print "-----------------------------"
                printf "%g paica |%g paica - PostScript |%g ponto |%g ponto - PostScript |%g px |%g twip |\n", fd, fe, ff, fg, fh, fi

                print "-----------------------------"
                print "------------DIDOT------------"
                print "-----------------------------"
                printf "%g cícero |%g ponto |\n", fj, fk

                print "-----------------------------"
                print "-------CALÇADO EUROPEU-------"
                print "-----------------------------"
                printf "%g ponto parisiense |\n", fl

                print "------------------------------"
                print "----------ASTRONOMIA----------"
                print "------------------------------"
                printf "%g z |%g pc |%g ano-luz |%g au |%g minuto-luz |%g segundo-luz |\n", fm, fn, fo, fp, fq, fr
                ...
                print "------------BÍBLIA------------"
                print "------------------------------"
                printf "%g côvado |%g palmo |%g tephach |%g etzbah |\n", ll, lm, ln, lo

                print "A CATEC agradece a sua consulta!"
            }'
            ;;
        4)
            read -p "Digite um valor em kg: " n1
            awk -v n1="$n1" 'BEGIN {
                a = n1 / 1000000
                b = n1 / 1000
                c = n1 
                ...
                print "---------APOTHECARIES---------"
                print "------------------------------"
                printf "%g lb |%g onça |%g dracma |%g escrópulo |%g grão |\n", hs, ht, hu, hv, hw
                
                print "------------------------------"
                print "-------------TROY-------------"
                print "------------------------------"
                printf "%g lb |%g ozt |%g dwt |%g ct |%g grão |%g mite |%g doite |\n", hl, hm, hn, ho, hp, hq, hr
                
                print "-----------------------------"
                print "---------AVOIRDUPOIS---------"
                print "-----------------------------"
                printf "%g T longa INGLATERRA |%g T curta EUA |%g klb Massa |%g quintal longo REINO UNIDO |%g centner britânico |%g quintal curto EUA |%g st |%g lb |%g oz |%g dr |%g gr |\n", ha, hb, hc, hd, he, hf, hg, hh, hi, hj, hk
                
                print "------------------------------"
                print "-----------PORTUGAL-----------"
                print "------------------------------"
                printf "%g @ |%g T |%g quintal |%g arrátel |%g quarta |%g onça |%g oitava |%g escrópulo |%g grão |\n", n, o, p, q, r, s, t, u, v
                
                print "-----------------------------"
                print "-----------ESPANHA-----------"
                print "-----------------------------"
                printf "%g T |%g alqueire de trigo |%g alqueire de centeio |%g alqueire de cevada |%g quintal |%g @ |%g £ |%g marco |%g cuarterón |%g onça |%g oitava |%g adame |%g grão |\n", w, x, y, z, aa, ab, ac, ad, ae, af, ag, ah, ai
                ...
                print "-------------ROMA-------------"
                print "------------------------------"
                printf "%g £ |%g onça |%g semionça |%g duella |%g sicílico |%g sextula |%g dracma |%g semisextula |%g escrópulo |%g óbolo |%g síliqua |%g deunx |%g dextans |%g dodrans |%g bes |%g septunx |%g semisse |%g quincunx |%g triente |%g quadrante |%g terúncio |%g sextante |%g sescúncia |\n", cn, co, cp, cq, cr, cs, ct, cu, cv, cw, cx, cy, cz, da, db, dc, dd, de, df, dg, dh, di, dj
            ...
            ;;
        5)
            read -p "Digite um valor em ºC: " n1
            awk -v a="$n1" 'BEGIN {
                b = a * 1.8 + 32
                c = 273.15 + a
                d = a * 0.8
            ...
            ;;
        6)
            read -p "Digite um valor em km/h: " n1
            awk -v n1="$n1" 'BEGIN {
                e = n1
                ...
                print "-------MEDIDAS MÉTRICAS-------"
                print "------------------------------"
                printf "%g km/s |%g m/s |%g quilômetro por minuto |%g metro por minuto |%g km/h |%g m/h |%g quilômetro por ano |%g metro por ano |\n", a, b, c, d, e, f, g, h
                
                print "------------------------------"
                print "-------EUA E INGLATERRA-------"
                print "------------------------------"
                printf "%g milha por segundo |%g pé por segundo |%g polegada por segundo |%g milha por minuto |%g pé por minuto |%g polegada por minuto |%g mph |%g pé por hora |%g polegada por hora |%g milha por ano |%g pé por ano |%g polegada por ano |\n", i, j, k, l, m, n, o, p, q, r, s, t
                
                print "-----------------------------"
                print "------------RITMO------------"
                print "-----------------------------"
                printf "%g minutos por quilômetro |%g segundos por quilômetro |%g segundos por 100 metros |%g minutos por milha |%g segundos por milha |%g segundos por 100 jardas |%g segundos por 500 metros |\n", u, v, w, x, y, z, aa
                
                print "-----------------------------"
                print "------UNIDADES NÁUTICAS------"
                print "-----------------------------"
                printf "%g nó |%g milha marítima por hora |\n", ab, ac
                
                print "------------------------------"
                print "------------FÍSICA------------"
                print "------------------------------"
                printf "%g velocidade do som no ar |%g velocidade da luz no vácuo |\n", ad, ae

                print "A CATEC agradece a sua consulta!"
            }'
            ;;
        *)
            echo "Tivemos um problema com os tipos de dados que você digitou!"
            ;;
    esac

    echo "Você deseja realizar mais uma pesquisa?"
    read -p "Digite [Sim] para realizar, caso contrário a nova pesquisa não será realizada
> " repetir
done

echo "A CATEC agradece a sua pesquisa!"