int converte() {
    ...
    while (strcmp(repeat, "Yes") == 0) {
        int escolha;
        printf("Welcome to CATEC - Unit Converter!\n");
        ...
        switch (escolha) {
            case 1: {
                ...
                printf("------------------------------\n");
                printf("--------METRIC MEASURES--------\n");
                printf("------------------------------\n");
                printf("%lf  m² | %lf dm² | %lf cm² | %lf mm² | %lf b | %lf km² | %lf hectare | %lf decare | %lf a |\n", a, b, c, d, e, f, g, h, i);

                printf("------------------------------\n");
                printf("--------USA AND ENGLAND--------\n");
                printf("------------------------------\n");
                printf("%lf township |%lf milha square |%lf homestead |%lf acre |%lf rood |%lf rod square |%lf perch |%lf yd² |%lf ft² |%lf in² |%lf th² |\n", j, k, l, m, n, o, p, q, r, s, t);
                ...
                printf("-------------ROME-------------\n");
                printf("-----------------------------\n");
                printf("%lf saltus |%lf centurium |%lf geredium |%lf uger |%lf akt square |%lf klima |%lf akt small square |%lf decimpeda square |%lf ped square usual |%lf ped square legal |\n", bn, bo, bp, bq, br, bs, bt, bu, bv, bw);

                printf("-----------------------------\n");
                printf("--------ANCIENT FRANCE--------\n");
                printf("-----------------------------\n");
                printf("%lf arpent |%lf perche |%lf toise square |%lf pied |%lf pouce |\n", bx, by, bz, ca, cb);

                printf("------------------------------\n");
                printf("---------ANCIENT SPAIN---------\n");
                printf("------------------------------\n");
                ...
                printf("-----------------------------\n");
                printf("------ANCIENT PORTUGUAL------\n");
                printf("-----------------------------\n");
                printf("%lf braça quadrada |%lf vara quadrada |%lf palmo quadrado |%lf polegada quadrada |\n", co, cp, cq, cr);

                printf("-----------------------------\n");
                printf("--------ANCIENT RUSSIA--------\n");
                printf("-----------------------------\n");
                printf("%lf desyatina country |%lf desyatina farmers |%lf verst square |%lf arshin square |%lf foot square |\n", cs, ct, cu, cv, cw);

                printf("------------------------------\n");
                printf("-----------NOWADAYS------------\n");
                printf("------------------------------\n");
                printf("%lf dulum (дулум) of Bosnia, Herzegovina and Serbia |%lf dynym or dylym of Albania |%lf donum of Cyprus |%lf skales (σκάλες) of Cyprus |%lf stremma grecian |%lf stremma turk in Greece |%lf dunam of Iraq |%lf dunam (dönüm, دونم) of Turkey, Syria, Israel, Palestine, Jordan, Lebano |%lf dunam (dönüm, دونم) ancient (before 1928) of Turkey, Syria, Israel, Palestine, Jordan, Lebano |%lf feddan (فدّان) of Egypt, Sudan, Syria, Oman |%lf kirat (قيراط) of Egypt |%lf manzana of Argentina |%lf manzana of Belize |%lf manzana of Costa Rica |%lf manzana of Guatemala |%lf manzana of Honduras |%lf manzana of Nicaragua |%lf cuadra of Argentina |%lf cuadra of Chile |%lf cuadra of Ecuador |%lf cuadra of Paraguay |%lf cuadra of Peru |%lf cuadra of Uruguay |%lf rod square of Panama and the Colombia |%lf rod square of Chile, Costa Rica, Republic Dominican, Ecuador, El Salvador, Guatemala, Honduras, Mexico, Nicaragua, Peru, Sao Tome and Principe, Venezuela |%lf rod square of Cuba |%lf rod square of Argentina, Paraguay, Uruguay |%lf rod square of Brazil |\n", cx, cy, cz, da, db, dc, dd, de, df, dg, dh, di, dj, dk, dl, dm, dn, doo, dp, dq, dr, ds, dt, du, dv, dw, dx, dy);

                printf("-----------------------------\n");
                printf("--------GAUGE OF WIRES--------\n");
                printf("-----------------------------\n");
                printf("%lf circle inch |%lf kcmil, MCM |%lf cmil |\n", dz, ea, eb);
                ...
                printf("The CATEC thanks you for your inquiry!\n");
                break;
            }
            case 2: {
                double n1;
                printf("Enter a value in l: ");
                scanf("%lf", &n1);
                double a = n1 / 100;
                double b = n1 / 10;
                double c = n1;
                ...
                printf("--------METRIC MEASURES--------\n");
                printf("------------------------------\n");
                printf("%lf hl |%lf decalitre |%lf l |%lf dl |%lf cl |%lf ml |%lf µl |%lf km³ |%lf m³ |%lf dm³ |%lf cc |%lf mm³ |\n", a, b, c, d, e, f, g, h, i, j, k, l);

                printf("------------------------------\n");
                printf("----------USA LIQUID----------\n");
                printf("------------------------------\n");
                printf("%lf acre-foot |%lf barrel (oil) |%lf gal |%lf qt |%lf pt |%lf gill |%lf fl oz |%lf fl dr |%lf min |\n", m, n, o, p, q, r, s, t, u);

                printf("-----------------------------\n");
                printf("----------USA DRIED----------\n");
                printf("-----------------------------\n");
                printf("%lf barrel |%lf bu |%lf pk |%lf gal |%lf qt |%lf pt |\n", v, w, x, y, z, aa);

                printf("------------------------------\n");
                printf("---------APOTHECARIES---------\n");
                printf("------------------------------\n");
                printf("%lf pt |%lf cup of glass |%lf cup of morning coffee |%lf cup of tea |%lf glass of wine |%lf ƒ℥ |%lf cup of soap |%lf dessert spoon |%lf ƒʒ |%lf cup of tea |%lf minim |\n", ab, ac, ad, ae, af, ag, ah, ai, aj, ak, al);

                printf("------------------------------\n");
                printf("------------ENGLAND------------\n");
                printf("------------------------------\n");
                printf("%lf perch |%lf barrel |%lf bu |%lf pk |%lf gal |%lf qt |%lf pt |%lf oz |%lf fl dr |%lf scrople liquid |%lf min |\n", au, av, aw, ax, ay, az, ba, bb, bc, bd, be);
                ...
                printf("---------ENGLAND|WINE---------\n");
                printf("------------------------------\n");
                printf("%lf tun |%lf butt |%lf puncheon |%lf hogsheads |%lf tierce |%lf barrel |%lf rundlet |\n", bl, bm, bn, bo, bp, bq, br);

                printf("------------------------------\n");
                printf("---------ENGLAND|BEER---------\n");
                printf("------------------------------\n");
                printf("%lf hogsheads |%lf barrel |%lf kilderkin |%lf firkin |%lf pin |\n", bs, bt, bu, bv, bw);

                printf("-----------------------------\n");
                printf("-----------USA|BEER-----------\n");
                printf("-----------------------------\n");
                printf("%lf Barrel of north-american beer |%lf Middle-barrel of north-american beer |%lf Barrelet of north-american beer (typical) |%lf Forth-barrel of north-american beer |\n", bx, by, bz, ca);

                printf("-----------------------------\n");
                printf("---------USA~KITCHEN---------\n");
                printf("-----------------------------\n");
                printf("%lf cup |%lf cup of soap |%lf cup of tea |\n", cb, cc, cd);

                printf("-----------------------------\n");
                printf("------AUSTRALIA~KITCHEN------\n");
                printf("-----------------------------\n");
                printf("%lf cup of soap |%lf dessert spoon |%lf cup of tea |\n", ce, cf, cg);
                ...
                printf("-----------ASTRONOMY-----------\n");
                printf("------------------------------\n");
                printf("%lf pc³ |%lf lightyear cubic |%lf lightminute cubic |%lf lightsecond cubic |\n", cl, cm, cn, co);

                printf("-----------------------------\n");
                printf("------------NAVAL------------\n");
                printf("-----------------------------\n");
                printf("%lf tonnage |%lf register ton |%lf Universal measuring system of Panama Canal |\n", cp, cq, cr);

                printf("-----------------------------\n");
                printf("-------------WOOD-------------\n");
                printf("-----------------------------\n");
                printf("%lf million of board-feet (mmfbm, mmbdft, mmbf) |%lf rope |%lf thousand board-feet (mfbm, mbdft, mbf) |%lf HT |%lf cubic ton of wood |%lf stere |%lf hoppus foot, hoppus ft³ (h ft) |%lf board-foot (fbmm, bdft, bf) |\n", cs, ct, cu, cv, cw, cx, cy, cz);
                ...
                printf("-----------------------------\n");
                printf("---ANCIENT PORTUGAL LIQUID---\n");
                printf("-----------------------------\n");
                ...
                printf("------------------------------\n");
                printf("-----ANCIENT RUSSIA DRIED-----\n");
                printf("------------------------------\n");
                printf("%lf cetverik |%lf vedro |%lf garnetz |\n", gu, gv, gw);

                printf("-----------------------------\n");
                printf("----ANCIENT RUSSIA LIQUID----\n");
                printf("-----------------------------\n");
            ...
            case 3: {
                ...
                printf("--------METRIC MEASURES--------\n");
                printf("------------------------------\n");
                printf("%lf km |%lf hm |%lf dam |%lf m |%lf dm |%lf cm |%lf mm |%lf micron |%lf nm |%lf Å|\n", a, b, c, d, e, f, g, h, i, j);

                printf("------------------------------\n");
                printf("--------USA AND ENGLAND--------\n");
                printf("------------------------------\n");
                printf("%lf league |%lf mi |%lf land |%lf furlong |%lf bolt |%lf chain |%lf pole |%lf rd |%lf perch |%lf yd |%lf ft |%lf span |%lf hand |%lf in |%lf line |%lf mil |%lf microinch |\n", k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa);
                
                printf("------------------------------\n");
                printf("------------ENGLAND------------\n");
                printf("------------------------------\n");
                printf("%lf league |%lf mi |%lf land |%lf skein |%lf bolt |%lf shackle |%lf furlong |%lf current |%lf rope |%lf pole |%lf goad |%lf ell |%lf yd |%lf rhythm |%lf cubit |%lf ft |%lf span |%lf nail |%lf shaftment |%lf hd |%lf plm |%lf in |%lf finger |%lf digitus |%lf barley grains |%lf poppy seeds |%lf line |%lf button |%lf calibre |%lf thou |%lf thousand |\n", ab, ac, ad, ae, af, ag, ah, ai, aj, ak, al, au, av, aw, ax, ay, az, ba, bb, bc, bd, be, bf, bg, bh, bi, bj, bk, bl, bm, bn);
                
                printf("-----------------------------\n");
                printf("-------SURVEYING OF USA-------\n");
                printf("-----------------------------\n");
                printf("%lf furlong |%lf ramsden´s current - engineer |%lf gunter´s current - surveyor |%lf gurley´s current |%lf gunter´s pole |%lf gunter´s yard |%lf ramsden´s link |%lf gunter´s link |%lf gurley´s link |%lf gunter´s foot |\n", bo, bp, bq, br, bs, bt, bu, bv, bw, bx);
                ...
                printf("----------NAUTIC USA----------\n");
                printf("-----------------------------\n");
                printf("%lf north-american miles maritime |%lf north-american cape |%lf fath |\n", cc, cd, ce);
                
                printf("------------------------------\n");
                printf("--------NAUTIC ENGLAND--------\n");
                printf("------------------------------\n");
                printf("%lf aim of admiralty |%lf cape of admiralty |\n", cf, cg);
                
                printf("-----------------------------\n");
                printf("------------SPAIN------------\n");
                printf("-----------------------------\n");
                printf("%lf cuadra (Argentina) |%lf cuadra (Bolivia) |%lf cuadra (Chile) |%lf cuadra (Colombia) |%lf cuadra (Ecuador) |%lf cuadra (Nicaragua) |%lf cuadra (Paraguay) |%lf cuadra (Uruguay) |%lf vara (Argentina) |%lf vara (Brazil) |%lf vara (Chile) |%lf vara (Colombia) |%lf vara (Costa Rica) |%lf vara (Cuba) |%lf vara (Republic Dominican) |%lf vara (Ecuador) |%lf vara (El Salvador) |%lf vara (Guatemala) |%lf vara (Honduras) |%lf vara (Mexico) |%lf vara (Nicaragua) |%lf vara (Panama) |%lf vara (Paraguay) |%lf vara (Peru) - peruvian |%lf vara (Peru) - spanish |%lf vara (Uruguay) |%lf vara (Sao Tome e Principe) |%lf vara (Venezuela) |\n", ch, ci, cj, ck, cl, cm, cn, co, cp, cq, cr, cs, ct, cu, cv, cw, cx, cy, cz, da, db, dc, dd, de, df, dg, dh, di);
                ...
                printf("-----------------------------\n");
                printf("------GERMANY GEOGRAPHIC------\n");
                printf("-----------------------------\n");
                printf("%lf geographic miles |\n", fa);
                ...
                printf("-------------ATA-------------\n");
                printf("-----------------------------\n");
                printf("%lf pica |%lf pica - PostScript |%lf point |%lf point - PostScript |%lf px |%lf twip |\n", fd, fe, ff, fg, fh, fi);
                
                printf("-----------------------------\n");
                printf("------------DIDOT------------\n");
                printf("-----------------------------\n");
                printf("%lf cicero |%lf point |\n", fj, fk);
                
                printf("-----------------------------\n");
                printf("--------EUROPEAN SHOES--------\n");
                printf("-----------------------------\n");
                printf("%lf parisian point |\n", fl);
                
                printf("------------------------------\n");
                printf("-----------ASTRONOMY-----------\n");
                printf("------------------------------\n");
                printf("%lf z |%lf pc |%lf lightyear |%lf au |%lf lightminute |%lf lightsecond |\n", fm, fn, fo, fp, fq, fr);
                
                printf("------------------------------\n");
                printf("---------GRACE HOPPER---------\n");
                printf("------------------------------\n");
                printf("%lf lightmicrosecond |%lf lightnanosecond |%lf lightpicosecond |\n", fs, ft, fu);
                ...
                printf("--------ANCIENT RUSSIA--------\n");
                printf("-----------------------------\n");
                printf("%lf milha |%lf verst |%lf mezhevaya verst |%lf kosaya sazhen |%lf sazhen |%lf makhovaya sazhen |%lf arshin |%lf lokot |%lf pé |%lf pyad |%lf vershok |%lf inch |%lf line |\n", jw, jx, jy, jz, ka, kb, kc, kd, ke, kf, kg, kh, ki);
                ...
                printf("------------------------------\n");
                printf("--------ANCIENT AUSTRIA--------\n");
                printf("------------------------------\n");
                printf("%lf meile |%lf ruthe |%lf klafner |%lf fuss |%lf zoll |%lf linie |%lf punkt |\n", kp, kq, kr, ks, kt, ku, kv);
                
                printf("-----------------------------\n");
                printf("--------ANCIENT SWEDEN--------\n");
                printf("-----------------------------\n");
                printf("%lf nymil |%lf mile |%lf fjärdingsväg |%lf rev before 1855 |%lf rev after 1855 |%lf stång |%lf famn |%lf aln |%lf fot |%lf kvarter |%lf tvärhand |%lf tum before 1855 |%lf tum after 1855 |%lf linje before 1855 |%lf linje after 1855 |\n", kw, kx, ky, kz, la, lb, lc, ld, le, lf, lg, lh, li, lj, lk);
                
                printf("------------------------------\n");
                printf("-------------BIBLE-------------\n");
                printf("------------------------------\n");
                printf("%lf cubit |%lf span |%lf tephach |%lf etzbah |\n", ll, lm, ln, lo);
            ...
            double n1;
                ...
                printf("------------COMMOM------------\n");
                printf("-----------------------------\n");
                printf("%lf kT |%lf T |%lf kg |%lf g |%lf cg |%lf mg |%lf mcg |%lf N |%lf kN |%lf ct |%lf centner metric |%lf yard metric |%lf amu |%lf M|\n", a, b, c, d, e, f, g, h, i, j, k, l, m, eq);

                printf("------------------------------\n");
                printf("---------APOTHECARIES---------\n");
                printf("------------------------------\n");
                printf("%lf lb |%lf ounce |%lf drachma |%lf scrople |%lf grain|\n", hs, ht, hu, hv, hw);

                printf("------------------------------\n");
                printf("-------------TROY-------------\n");
                printf("------------------------------\n");
                printf("%lf lb |%lf ozt |%lf dwt |%lf ct |%lf grain |%lf mite |%lf doite|\n", hl, hm, hn, ho, hp, hq, hr);

                printf("-----------------------------\n");
                printf("---------AVOIRDUPOIS---------\n");
                printf("-----------------------------\n");
                printf("%lf T long ENGLAND |%lf T short USA |%lf klb Mass |%lf yard long UNITED KINGDOM |%lf centner britain |%lf yard short USA |%lf st |%lf lb |%lf oz |%lf dr |%lf gr|\n", ha, hb, hc, hd, he, hf, hg, hh, hi, hj, hk);
                ...
                printf("------------SPAIN------------\n");
                printf("-----------------------------\n");
                printf("%lf T |%lf wheat bushel |%lf rye bushel |%lf barley bushel |%lf yard |%lf @ |%lf £ |%lf mark |%lf cuarterón |%lf ounce |%lf eighth |%lf adame |%lf grain |\n", w, x, y, z, aa, ab, ac, ad, ae, af, ag, ah, ai);
                ...
                printf("-------------ROME-------------\n");
                printf("------------------------------\n");
                printf("%lf £ |%lf ounce |%lf demiounce |%lf duella |%lf sicílico |%lf sextula |%lf dracma |%lf semisextula |%lf escrópulo |%lf óbolo |%lf síliqua |%lf deunx |%lf dextans |%lf dodrans |%lf bes |%lf septunx |%lf semisse |%lf quincunx |%lf triente |%lf quadrante |%lf terúncio |%lf sextante |%lf sescúncia |\n", cn, co, cp, cq, cr, cs, ct, cu, cv, cw, cx, cy, cz, da, db, dc, dd, de, df, dg, dh, di, dj);

                printf("------------------------------\n");
                printf("--------EGINETIC GREECE--------\n");
                printf("------------------------------\n");
                printf("%lf talent |%lf mine |%lf decadracma |%lf tetradracma |%lf didracma |%lf estáter |%lf dracma |%lf tetróbolo |%lf trióbolo |%lf dióbolo |%lf óbolo |%lf tritartemorion |%lf hemióbolo |%lf trihemitetartemorion |%lf tetartemorion |%lf hemitetartemorion |\n", dk, dl, dm, dn, doo, dp, dq, dr, ds, dt, du, dv, dw, dx, dy, dz);
                ...
                printf("-------------BIBLE-------------\n");
                printf("------------------------------\n");
                printf("%lf talent |%lf mine |%lf siclo |%lf pim |%lf beca |%lf gera |\n", ch, ci, cj, ck, cl, cm);
            ...
            case 6: {
                ...
                printf("---------METRIC SIZES---------\n");
                printf("------------------------------\n");
                printf("%lf km/s |%lf m/s |%lf quilometer per minute |%lf meter per minute |%lf km/h |%lf m/h |%lf quilometer per year |%lf meter per year |\n", a, b, c, d, e, f, g, h);
                printf("------------------------------\n");
                printf("--------USA AND ENGLAND--------\n");
                printf("------------------------------\n");
                printf("%lf miles per second |%lf foot per second |%lf inch per second |%lf miles per minute |%lf foot per minute |%lf inch per minute |%lf mph |%lf foot per hour |%lf inch per hour |%lf miles per year |%lf foot per year |%lf inch per year |\n", i, j, k, l, m, n, o, p, q, r, s, t);
                printf("-----------------------------\n");
                printf("------------RITHM------------\n");
                printf("-----------------------------\n");
                printf("%lf minutes per quilometer |%lf seconds per quilometer |%lf seconds per 100 meters |%lf minutes per mile |%lf seconds per mile |%lf seconds per 100 yards |%lf seconds per 500 meters |\n", u, v, w, x, y, z, aa);
                printf("-----------------------------\n");
                printf("---------NAUTIC UNIT---------\n");
                printf("-----------------------------\n");
                printf("%lf node |%lf mile maritime per hour |\n", ab, ac);
                printf("------------------------------\n");
                printf("------------PHYSICS------------\n");
                printf("------------------------------\n");
                printf("%lf sound speed on air |%lf light speed on vacuum |\n", ad, ae);

                printf("The CATEC thanks you for your inquiry!\n");
                break;
            }
            default:
                printf("Has an error occurred! Please, try again.\n");
        }
        printf("You want to make another conversion? (Yes/No): ");
        scanf("%s", repeat);
    }
    printf("The CATEC thanks you for using our converter!\n");
    return 0;
}